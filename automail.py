...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    class AutomailConfig:
        def __init__(self, master=None):
            ...
            self.n_chamado.place(anchor='nw', relx='0.14', rely='0.04', width='30', x='0', y='0')
            self.n_assunto = ttk.Entry(self.frame_6)
            self.n_assunto.config(justify='center')
            self.n_assunto.place(anchor='nw', relx='0.38', rely='0.04', width='30', x='0', y='0')
            self.n_email = ttk.Entry(self.frame_6)
            self.n_email.config(justify='center')
            self.n_email.place(anchor='nw', relx='0.62', rely='0.04', width='30', x='0', y='0')
            self.label_7 = ttk.Label(self.frame_6)
            self.label_7.config(justify='center', text='Coluna\nChamado')
            self.label_7.place(anchor='nw', relx='0.01', rely='0.02', x='0', y='0')
            self.label_8 = ttk.Label(self.frame_6)
            self.label_8.config(justify='center', text='Coluna\nE-mail')
            self.label_8.place(anchor='nw', relx='0.49', rely='0.02', x='0', y='0')
            self.label_9 = ttk.Label(self.frame_6)
            self.label_9.config(justify='center', text='Coluna\nAssunto')
            self.label_9.place(anchor='nw', relx='0.25', rely='0.02', x='0', y='0')
            ...
            self.label_1_2 = ttk.Label(self.frame_6)
            self.label_1_2.config(justify='center', text='Coluna\nDescrição')
            ...
            self.frame_6.place(anchor='nw', relx='0.0', rely='0.0', x='0', y='0')
